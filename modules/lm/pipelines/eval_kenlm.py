...
DEFAULT_ARPA = BASE_DIR / "char_kenlm.arpa"
...
def beam_search_char_lm(
    ...
    今回は“transform修正”が主目的なので挙動は変えない。
    """
    state0 = kenlm.State()
...
def main():
    ...
    # ★ transform: match training val_tf style
    ...
    # NOTE: pretrained=True here is used ONLY to get a defined default_cfg.
    # You still load your own ckpt afterwards.
    ...
    # ---- transform (fixed to match training val_tf style) ----
...
python eval_kenlm.py \
  ...
  --box-width 4 \
  --out-dir ./outputs/kenlm/effb0_200017458/0.2
"""
