...
CLASS_JSON        = os.path.join(BASE_DIR, "trained_class_map.json")
...
# YOLOX設定
YOLOX_EXP_PATH  = os.path.join(BASE_DIR, "nano.py")
YOLOX_CKPT_PATH = os.path.join(BASE_DIR, "best_ckpt.pth")
YOLOX_CONF      = 0.35
YOLOX_NMS       = 0.45
YOLOX_SIZE      = 640
